...
from opgo import zobrist
from opgo.gotypes import Player, Point
from opgo.scoring import compute_game_result
from opgo.utils import MoveAge
...
class Move:
    ...
    def __init__(self, point=None, is_pass=False, is_resign=False, is_play=False):
